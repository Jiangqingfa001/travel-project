          ...
          <template v-else-if="tripData && tripData.success !== false">
            ...
            <div class="card budget-card" v-if="tripData.budgetBreakdown">
                <div class="section-title">
                  ...
                  <BudgetItem :data="tripData.budgetBreakdown" :total="tripData.totalBudget" />
            </div>
            ...
            <div class="card warning-card" v-if="tripData.warnings && tripData.warnings.length">
              <div class="section-title">
                注意事项
              </div>
              <ul class="marnings-list">
